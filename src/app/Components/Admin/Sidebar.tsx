...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-72 shrink-0 bg-[#0F172A] text-white flex flex-col shadow-xl transform transition-transform duration-300 md:static md:translate-x-0 ${
